...
/// * While it's possible to create new instances of this class, it's better to use <see cref="Factories.Suspicious.Ok" /> property of <see cref="Factories.Suspicious"/> factory.
/// </remarks>
